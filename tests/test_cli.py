...
from pyenv_doctor.cli import main
...
class TestCLI:
    ...
    def test_cli_no_conflicts(self):
        ...
        预期结果: 显示未发现冲突
        """
        with patch("pyenv_doctor.cli.EnvScanner") as mock_scanner_cls, \
             patch("pyenv_doctor.cli.ConflictSolver") as mock_solver_cls:
    ...
    def test_cli_with_conflicts(self):
        ...
        with patch("pyenv_doctor.cli.EnvScanner") as mock_scanner_cls, \
             patch("pyenv_doctor.cli.ConflictSolver") as mock_solver_cls, \
             patch("pyenv_doctor.cli.SandboxExecutor") as mock_executor_cls:
    ...
    def test_cli_custom_timeout(self):
        ...
        with patch("pyenv_doctor.cli.EnvScanner") as mock_scanner_cls, \
            ...
            runner = CliRunner()
            result = runner.invoke(main, ["--timeout", "120"])
